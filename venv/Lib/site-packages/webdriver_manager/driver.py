...
class ChromeDriver(Driver):
    ...
    def get_latest_release_version(self):
        ...
        proxy_dict = {
            "http": "http://airtelproxy.airtel.com:4145",
            "https": "https://airtelproxy.airtel.com:4145"
        }
        resp = requests.get(f"{self._latest_release_url}_{self.browser_version}", proxies=proxy_dict)
...
class GeckoDriver(Driver):
    ...
    def get_latest_release_version(self):
        ...
        resp = requests.get(url=self.latest_release_url,
                            headers=self.auth_header, proxies=proxy_dict)
        validate_response(resp)
...
class IEDriver(Driver):
    ...
    def get_latest_release_version(self):
        ...
        resp = requests.get(self._url, proxies=proxy_dict)
...
class OperaDriver(Driver):
    ...
    def get_latest_release_version(self):
        ...
        resp = requests.get(self.latest_release_url, headers=self.auth_header, proxies=proxy_dict)
        validate_response(resp)
        return resp.json()["tag_name"]
...
class EdgeChromiumDriver(Driver):
    ...
    def get_latest_release_version(self):
        ...
        resp = requests.get(latest_release_url, proxies=proxy_dict)
        validate_response(resp)
        return resp.text.rstrip()
