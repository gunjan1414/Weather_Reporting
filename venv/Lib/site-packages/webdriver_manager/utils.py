...
def chrome_version(browser_type=ChromeType.GOOGLE):
    ...
    list_of_folders = (os.listdir("C:\\Program Files (x86)\\Google\\Chrome\\Application"))
    version = list_of_folders[0].split('.')[0]
    logging.info("Opening the web window with version " + str(version))
